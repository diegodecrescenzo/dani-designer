...
@section('content')
    ...
    <div class="col-md-8 mx-auto my-5">
        <h4 class="mb-4">Entre em contato comigo!</h4>
        <form class="pt-3" novalidate action="{{route('site.contact')}}" method="post">
            ...
            <button class="btn btn-secondary btn-block" type="submit">Enviar E-mail</button>
